...
$router->get('list-students',[App\Controllers\StudentController::class,'getStudent']);
...
$router->post('update-student/{id}',[App\Controllers\StudentController::class,'updateStudent']);
